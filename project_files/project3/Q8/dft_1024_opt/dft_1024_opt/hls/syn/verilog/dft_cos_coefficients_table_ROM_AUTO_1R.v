...
initial begin
    ...
    $readmemh("./dft_cos_coefficients_table_ROM_AUTO_1R.dat", rom1); 
    $readmemh("./dft_cos_coefficients_table_ROM_AUTO_1R.dat", rom2); 
    $readmemh("./dft_cos_coefficients_table_ROM_AUTO_1R.dat", rom3);
end
